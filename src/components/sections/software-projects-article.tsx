      ...
      <div class="project-container">
        ...
        <div class="router left">
          <div class="project-link">
            <a href="https://www.sedaia-designs.org/projects/blender-development"
          ...
          <div class="project-link">
            <a href="https://gitlab.com/sedaia-designs/blender_pycharm"
              rel={"noreferrer noopener"}
              target={"_blank"}
            >
              Source
          ...
          <div class="project-link">
            <a href="https://docs.blender-development.sakura-sedaia.tech/"
              rel={"noreferrer noopener"}
              target={"_blank"}
            >
              Documentation
